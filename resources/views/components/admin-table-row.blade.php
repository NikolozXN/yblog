...
<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
    <th scope="row"
        ...
        <div class=" overflow-hidden">
            <img class="w-16 h-16 object-cover rounded-full" src="{{ asset('/storage/' . $user->avatar) }}" alt="">
        </div>
        <div class="pl-3">
    ...
    <td class="px-6 py-4 flex gap-2">
        <a href="/" class="font-medium text-gray-600 dark:text-blue-500 hover:text-blue-600"><svg
